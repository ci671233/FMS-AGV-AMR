...
router.put('/update/:factoryID', factoryController.updateFactory);
// 공장에 사용자 추가 (공장 관리자만 접근 가능)
router.put('/add_user/:factoryID/:userID', factoryController.addUserToFactory);
// 공장에 공장 관리자 권한 부여 (공장 관리자만 접근 가능)
router.put('/add_admin/:factoryID/:adminID', factoryController.addAdminToFactory);
