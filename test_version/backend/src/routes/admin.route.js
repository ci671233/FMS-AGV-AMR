...
// 가입 승인
router.get('/pending/account', adminController.getPendingAccounts);
router.post('/approve/account/:accountID', adminController.approveAccount);

// 권한 승인
router.get('/pending/role', adminController.getPendingRoleRequests);
router.post('/approve/role/:accountID', adminController.approveRoleRequest);

// 공장 승인
router.get('/pending/factory', adminController.getPendingFactories);
router.post('/approve/factory/:factoryID',adminController.approveFactory);
